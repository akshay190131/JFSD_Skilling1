...
class Skill1Q2 {
    ...
    public static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        String dbUserPassword = "Aravind*123";

        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/JFSD", dbUserName, dbUserPassword);
    ...
    public static void create_students_table(Connection con) {
        try {
            ...
            int[] id = {131,200,141,027};
            String[] names = { "Akshay", "Ramdev", "Sudheendra", "Vijay"};
            String[] gender = { "male", "male", "male", "male" };
            int[] year = { 3, 3, 3, 3 };
            String[] department = { "cse", "cse", "cse", "cse"};
            String[] kl_mail = { "131@kluniversity.in", "200@kluniversity.in", "141@kluniversity.in",
                    "027@kluniversity.in" };
            double[] cgpa = { 5.00, 7.80, 9.00, 10.00};
            int[] num_of_backlogs = { 20, 0, 0, 0};
